...
\ReleaseProject{2} %Replace 0 by 1 if release project; Replace 0 by 2 if not release project
...
\include{contents/literature_review}
\include{contents/dataset}
\include{contents/methodology_implementation}
\include{contents/main_results}
\include{contents/legal_ethical_professional_issues}
